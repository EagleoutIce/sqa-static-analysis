...
\begin{tikzpicture}[overlay,remember picture]
   ...
   \only<9-11|handout:2>{%
      \draw[Kite-,line cap=round,gray] ([yshift=2.95mm,xshift=1.5mm]pic cs:union-on-loops) to[out=90,in=180] ++(5mm,3mm) node[right,font=\footnotesize] {\tiny we join on loops because, at this point \textit{x} can have any of the values};
   }%
   \onslide<6->{%
