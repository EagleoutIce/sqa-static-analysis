...
\begin{tikzpicture}[line cap=round]
   ...
   \onslide<11->{%
      \draw[Circle-,red,rounded corners=4pt] (7.75,2.9) -- ++(.35,.5) -- ++(.5,0) node[right,align=left,text width=6cm] {(Trace) Abstraction\textsuperscript{\cite[92]{cousout2021principles}}\\[-2pt]\footnotesize\color{gray}just one of many\\[-2pt]\footnotesize\color{gray}this \textbf{must} include all concrete traces (over-approximate)!};
   }
