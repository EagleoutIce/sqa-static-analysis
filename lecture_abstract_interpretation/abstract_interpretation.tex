...
\end{tikzpicture}
      ...
      \item<6-> Do we need widening? If so, define \absexpr{\widen}!\\[2pt]
         \onslide<11-|handout:2>{\textcolor{gray}{\textit{We do not need widening here as our lattice is finite\\and our semantics do not introduce new elements. (We will concretize this next week.)}}}
   \end{enumerate}}
   };
   }
\end{tikzpicture}  
