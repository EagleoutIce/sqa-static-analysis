...
\end{bnf}\begin{tikzpicture}[overlay,remember picture]
   \onslide<8-|handout:2>{%
      \node[right=20mm,yshift=.25mm+2mm,text width=8cm,font=\footnotesize,gray] (@1) at (constant.east) {%
      ...
      \node[below right,yshift=.25mm+3.5mm,text width=8cm,font=\footnotesize,gray] at (add.east-|@1.west) {%
...
\begin{frame}{The Domains We Built\ldots}
   \begin{itemize}
      ...
      \end{itemize}
      \item<9-> With abstract interpretation wie interpret programs \textit{over} these domains!
...
\begin{frame}{Combining Domains: Products}
   ...
   \onslide<12->{
      \node[above left=1.5mm,yshift=2.75mm,
         href node={www.uni-ulm.de/in/sp/team/oliver-gerstl/},
         align=right,
