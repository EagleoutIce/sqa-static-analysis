...
\savebox\pinguA{\tikz{\pingu[right wing wave,lollipop left,eyes shiny,conical hat,body type=leacy]}}
...
\begin{tikzpicture}[overlay,remember picture]
   \onslide<9->{\node[above left=.5mm,yshift=3.5mm] at(current page.south east) {\scalebox{.6}{\usebox\pinguA}};}
\end{tikzpicture}
\end{frame}
